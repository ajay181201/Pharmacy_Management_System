...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("Database6DataSet2"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class Database6DataSet2
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As Database6DataSet2 = CType(MyBase.Clone,Database6DataSet2)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "Database6DataSet2"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/Database6DataSet2.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As Database6DataSet2 = New Database6DataSet2()
    ...
    Partial Public Class CUSTOMERDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddCUSTOMERRow(ByVal CUSTOMER_NAME As String, ByVal DOB As Date, ByVal ADDRESS As String, ByVal PINCODE As Integer, ByVal MOBILE_NO As Double) As CUSTOMERRow
            Dim rowCUSTOMERRow As CUSTOMERRow = CType(Me.NewRow,CUSTOMERRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, CUSTOMER_NAME, DOB, ADDRESS, PINCODE, MOBILE_NO}
        ...
        Private Sub InitClass()
            ...
            Me.columnMOBILE_NO = New Global.System.Data.DataColumn("MOBILE_NO", GetType(Double), Nothing, Global.System.Data.MappingType.Element)
...
Namespace Database6DataSet2TableAdapters
    ...
    Partial Public Class CUSTOMERTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `CUSTOMER` WHERE ((`CUSTOMER_ID` = ?) AND ((? = 1 AND `CUSTOMER_NAME`"& _ 
                " IS NULL) OR (`CUSTOMER_NAME` = ?)) AND ((? = 1 AND `DOB` IS NULL) OR (`DOB` = ?"& _ 
                ")) AND ((? = 1 AND `ADDRESS` IS NULL) OR (`ADDRESS` = ?)) AND ((? = 1 AND `PINCO"& _ 
                "DE` IS NULL) OR (`PINCODE` = ?)) AND ((? = 1 AND `MOBILE_NO` IS NULL) OR (`MOBIL"& _ 
                "E_NO` = ?)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_MOBILE_NO", Global.System.Data.OleDb.OleDbType.[Double], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "MOBILE_NO", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._adapter.InsertCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `CUSTOMER` (`CUSTOMER_NAME`, `DOB`, `ADDRESS`, `PINCODE`, `MOBILE_NO`"& _ 
                ") VALUES (?, ?, ?, ?, ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("MOBILE_NO", Global.System.Data.OleDb.OleDbType.[Double], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "MOBILE_NO", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.UpdateCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `CUSTOMER` SET `CUSTOMER_NAME` = ?, `DOB` = ?, `ADDRESS` = ?, `PINCODE` = "& _ 
                "?, `MOBILE_NO` = ? WHERE ((`CUSTOMER_ID` = ?) AND ((? = 1 AND `CUSTOMER_NAME` IS"& _ 
                " NULL) OR (`CUSTOMER_NAME` = ?)) AND ((? = 1 AND `DOB` IS NULL) OR (`DOB` = ?)) "& _ 
                "AND ((? = 1 AND `ADDRESS` IS NULL) OR (`ADDRESS` = ?)) AND ((? = 1 AND `PINCODE`"& _ 
                " IS NULL) OR (`PINCODE` = ?)) AND ((? = 1 AND `MOBILE_NO` IS NULL) OR (`MOBILE_N"& _ 
                "O` = ?)))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("MOBILE_NO", Global.System.Data.OleDb.OleDbType.[Double], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "MOBILE_NO", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_MOBILE_NO", Global.System.Data.OleDb.OleDbType.[Double], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "MOBILE_NO", Global.System.Data.DataRowVersion.Original, false, Nothing))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT CUSTOMER_ID, CUSTOMER_NAME, DOB, ADDRESS, PINCODE, MOBILE_NO FROM CUSTOMER"& _ 
                ""
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Database6DataSet2.CUSTOMERDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Database6DataSet2.CUSTOMERDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database6DataSet2.CUSTOMERDataTable = New Database6DataSet2.CUSTOMERDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Database6DataSet2.CUSTOMERDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As Database6DataSet2) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_CUSTOMER_ID As Integer, ByVal Original_CUSTOMER_NAME As String, ByVal Original_DOB As Global.System.Nullable(Of Date), ByVal Original_ADDRESS As String, ByVal Original_PINCODE As Global.System.Nullable(Of Integer), ByVal Original_MOBILE_NO As Global.System.Nullable(Of Double)) As Integer
            ...
            If (Original_MOBILE_NO.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(10).Value = CType(Original_MOBILE_NO.Value,Double)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal CUSTOMER_NAME As String, ByVal DOB As Global.System.Nullable(Of Date), ByVal ADDRESS As String, ByVal PINCODE As Global.System.Nullable(Of Integer), ByVal MOBILE_NO As Global.System.Nullable(Of Double)) As Integer
            ...
            If (MOBILE_NO.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(4).Value = CType(MOBILE_NO.Value,Double)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal CUSTOMER_NAME As String, ByVal DOB As Global.System.Nullable(Of Date), ByVal ADDRESS As String, ByVal PINCODE As Global.System.Nullable(Of Integer), ByVal MOBILE_NO As Global.System.Nullable(Of Double), ByVal Original_CUSTOMER_ID As Integer, ByVal Original_CUSTOMER_NAME As String, ByVal Original_DOB As Global.System.Nullable(Of Date), ByVal Original_ADDRESS As String, ByVal Original_PINCODE As Global.System.Nullable(Of Integer), ByVal Original_MOBILE_NO As Global.System.Nullable(Of Double)) As Integer
            If (CUSTOMER_NAME Is Nothing) Then
            ...
            End If
            If (MOBILE_NO.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(MOBILE_NO.Value,Double)
            Else
            ...
            If (Original_DOB.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_DOB.Value,Date)
            Else
            ...
            If (Original_MOBILE_NO.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(15).Value = CType(Original_MOBILE_NO.Value,Double)
            Else
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As Database6DataSet2, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As Database6DataSet2, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._cUSTOMERTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As Database6DataSet2, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._cUSTOMERTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As Database6DataSet2) As Integer
